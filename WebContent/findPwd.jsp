...
<body>
  <div id="all">
    <header>
      ...
      <div class="login">
            <a href="findPwd.jsp" id="he"><h1>비밀번호 찾기</h1></a>
            <form action="findPwd.do" method="post" onsubmit="return check(this)">
                <div><h4>아이디</h4><input type="text" name="id" id="id" placeholder="ID" autofocus required></div>
                <div class="in2"><h4>이름</h4><input type="text" name="name" id="name" placeholder="Name" required></div>
